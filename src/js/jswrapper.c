...
static const JswSymPtr jswSymbols_global[] FLASH_SECT = {
  ...
  {162, JSWAT_VOID, (void (*)(void))jswrap_led_constructor},
  ...
  {333, JSWAT_JSVAR | (JSWAT_JSVAR << (JSWAT_BITS*1)), (void (*)(void))jswrap_decodeURIComponent},
  {352, JSWAT_JSVAR | (JSWAT_JSVAR << (JSWAT_BITS*1)), (void (*)(void))jswrap_encodeURIComponent},
  {371, JSWAT_JSVAR | (JSWAT_JSVAR << (JSWAT_BITS*1)), (void (*)(void))jswrap_eval},
  {376, JSWAT_BOOL | (JSWAT_JSVAR << (JSWAT_BITS*1)), (void (*)(void))jswrap_isNaN},
  {382, JSWAT_JSVARFLOAT | (JSWAT_JSVAR << (JSWAT_BITS*1)), (void (*)(void))jswrap_parseFloat},
  {393, JSWAT_JSVAR | (JSWAT_JSVAR << (JSWAT_BITS*1)) | (JSWAT_JSVAR << (JSWAT_BITS*2)), (void (*)(void))jswrap_parseInt},
  {402, JSWAT_JSVAR, (void (*)(void))gen_jswrap_process_process},
  {410, JSWAT_JSVAR | (JSWAT_JSVAR << (JSWAT_BITS*1)), (void (*)(void))jswrap_require}
};
...
static const JswSymPtr jswSymbols_LED_proto[] FLASH_SECT = {
  {0, JSWAT_VOID | JSWAT_THIS_ARG | (JSWAT_INT32 << (JSWAT_BITS*1)), (void (*)(void))jswrap_led_set}
};
static const unsigned char jswSymbolIndex_LED_proto = 26;


FLASH_STR(jswSymbols_global_str, "Array\0ArrayBuffer\0ArrayBufferView\0Boolean\0DataView\0Date\0Error\0Float32Array\0Float64Array\0Function\0HIGH\0Infinity\0Int16Array\0Int32Array\0Int8Array\0InternalError\0JSON\0LED\0LOW\0Math\0Modules\0NaN\0Number\0Object\0Promise\0ReferenceError\0RegExp\0String\0SyntaxError\0TypeError\0Uint16Array\0Uint32Array\0Uint8Array\0Uint8ClampedArray\0arguments\0atob\0btoa\0decodeURIComponent\0encodeURIComponent\0eval\0isNaN\0parseFloat\0parseInt\0process\0require\0");
...
FLASH_STR(jswSymbols_LED_proto_str, "set\0");

const JswSymList jswSymbolTables[] FLASH_SECT = {
  {jswSymbols_global, jswSymbols_global_str, 45},
  ...
  {jswSymbols_LED_proto, jswSymbols_LED_proto_str, 1},
};
...
const JswSymList *jswGetSymbolListForConstructorProto(JsVar *constructor) {
  ...
  if (constructorPtr==(void*)jswrap_led_constructor) return &jswSymbolTables[jswSymbolIndex_LED_proto];
  return 0;
}
